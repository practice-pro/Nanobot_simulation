...
namespace eval ::StrideWorkaround:: {

  variable defaultMolid {top}
  variable defaultSeltext {protein}
  variable defaultSplit {chain}
  variable prefix {tmp_stride_workaround_}

}

proc create_structure_macros { args } { return [eval ::StrideWorkaround::create_structure_macros $args] }

proc set_structure { args } { return [eval ::StrideWorkaround::set_structure $args] }
...
proc ::StrideWorkaround::create_structure_macros_usage {} {
...
proc ::StrideWorkaround::set_structure_usage {} {
...
proc ::StrideWorkaround::create_structure_macros { args } {
...
proc ::StrideWorkaround::set_structure { args } {
